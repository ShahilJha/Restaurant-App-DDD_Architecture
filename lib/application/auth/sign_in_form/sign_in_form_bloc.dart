...
import 'package:restaurant_app/domain/auth/value_objects.dart';
...
class SignInFormBloc extends Bloc<SignInFormEvent, SignInFormState> {
  ...
  Stream<SignInFormState> mapEventToState(
    ...
    yield* event.map(
      ...
      toggledPasswordObscurity: (e) async* {
        yield state.copyWith(
          obscurePassword: !e.obscurePassword,
        );
      },
      clearedEmailAddress: (e) async* {
        yield state.copyWith(
      ...
      signInWithGooglePressed: (e) async* {
        ...
        print(
            'DEBUGGINH : ${failureOrSuccess.fold((l) => l.toString(), (r) => r.toString())}');
        yield state.copyWith(
          isSubmitting: false,
